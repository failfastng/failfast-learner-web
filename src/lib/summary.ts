...
type VariantRender =
  ...
  | { variant: 'STRUGGLE'; corrections: number; walkThroughs: number; perfectTotal: number; actualTotal: number };
...
export function selectSummaryVariant(
  ...
  if (tierState.maths === 'Skilled' && tierState.english === 'Skilled' && tierState.economics === 'Skilled') {
